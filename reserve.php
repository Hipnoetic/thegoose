<?php
      ...
      $to = 'cj.chamberlain1385@gmail.com';  // please change this email id
      ...
      if (!isset($_POST['guest'])) {
            $errors['guest'] = 'Please enter your phone number';
      }
      ...
      $from = $email;
      $subject = 'Contact Form : The Goose & Gridiron Reservation System';
